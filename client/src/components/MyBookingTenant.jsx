...
function MyBookingTenant(props) {
  useEffect(() => {
                  ...
                  <Row className="justify-content-end">
                    ...
                    <Col className="d-flex" lg={2}>
                      <p
                        className={
                          value.status_payment === "success"
                            ? "text-success w-50 text-center text-success"
                            : value.status_payment === "Pending"
                            ? "text-warning w-50 text-center text-warning"
                            : "text-danger w-50 text-center text-warning"
                        }
                      >
...
export default MyBookingTenant;
